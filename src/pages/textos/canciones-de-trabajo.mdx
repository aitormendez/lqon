...
import imageAlarmMobile from "../../assets/img/canciones-trabajo/alarm-clock-mobile.jpg";
import imageAlarmDesktop from "../../assets/img/canciones-trabajo/alarm-clock-desktop.jpg";
