...
const $$BtnMenu = createComponent(async ($$result, $$props, $$slots) => {
  ...
  Astro2.self = $$BtnMenu;
  const baseClass = "bg-white p-[2vw] flex flex-col justify-center gap-[0.5vw] w-[10vw] items-center hover:bg-black";
  return renderTemplate`${maybeRenderHead()}<button id="burger"${addAttribute(`${baseClass}`, "class")}> <i class="block bg-red-600 w-[3vw] h-[0.7vw]"></i> <i class="block bg-red-600 w-[3vw] h-[0.7vw]"></i> <i class="block bg-red-600 w-[3vw] h-[0.7vw]"></i> </button> `;
...
const $$Solapa = createComponent(async ($$result, $$props, $$slots) => {
  ...
  Astro2.self = $$Solapa;
  return renderTemplate`${maybeRenderHead()}<div id="solapa"> <div id="solapa-wrapper" class="absolute bg-black w-full min-h-full z-50 top-0 -left-full transition-all duration-1000"> ${renderComponent($$result, "StationLinks", StationLinks, { "client:load": true, "client:component-hydration": "load", "client:component-path": "/Users/aitor/Documents/Sites/lqon/src/components/StationLinks", "client:component-export": "default" })} </div> </div>`;
...
const $$Layout = createComponent(async ($$result, $$props, $$slots) => {
  ...
  Astro2.self = $$Layout;
  const { titulo, nombre, tipo } = Astro2.props;
  return renderTemplate`<html lang="en"> ${renderComponent($$result, "CommonHead", $$CommonHead, { "tipo": tipo, "nombre": nombre })}${maybeRenderHead()}<body class="text-white"> ${renderComponent($$result, "Header", $$Header, {})} <main class="font-serif"> ${renderSlot($$result, $$slots["default"])} </main>   </body> </html>`;
...
export { $$Image as $, StationLinks as S, $$Layout as a, brianaWeapons as b, imageConfig as i };
