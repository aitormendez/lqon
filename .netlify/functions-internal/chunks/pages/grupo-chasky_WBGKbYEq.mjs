/* empty css                                   */
import { e as createAstro, f as createComponent, r as renderTemplate, m as maybeRenderHead, k as renderSlot, _ as __astro_tag_component__, F as Fragment$1, n as createVNode } from '../astro__iBP4jqW.mjs';
...
const $$Prose = createComponent(async ($$result, $$props, $$slots) => {
  ...
  Astro2.self = $$Prose;
  return renderTemplate`${maybeRenderHead()}<div class="prose prose-lqon
  prose-h1:font-bold prose-h1:text-3xl prose-p:text-3xl
  prose-a:text-blue-600 prose-p:text-justify prose-img:rounded-xl"> ${renderSlot($$result, $$slots["default"])} </div>`;
