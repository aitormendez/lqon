/* empty css                                   */
import 'html-escaper';
import { e as createAstro, f as createComponent, r as renderTemplate, g as addAttribute, h as renderComponent, i as renderHead, m as maybeRenderHead, j as createTransitionScope, k as renderSlot } from '../astro_H8YBTxzw.mjs';
import 'kleur/colors';
import 'clsx';
...
import { useGLTF, Text, useProgress, Html } from '@react-three/drei';
...
function Loader() {
  ...
  return /* @__PURE__ */ jsxs(Html, { center: true, children: [
    progress,
    " % loaded"
  ] });
}
