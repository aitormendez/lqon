...
const StationLinks = () => {
  ...
  return /* @__PURE__ */ jsx(Fragment, { children: textoStations.map((station, index) => /* @__PURE__ */ jsx(
    "a",
    {
...
const $$Layout = createComponent(async ($$result, $$props, $$slots) => {
  ...
  Astro2.self = $$Layout;
  const { titulo, nombre, tipo } = Astro2.props;
  return renderTemplate`<html lang="en"> ${renderComponent($$result, "CommonHead", $$CommonHead, { "tipo": tipo, "nombre": nombre })}${maybeRenderHead()}<body class="text-white"> ${renderComponent($$result, "Header", $$Header, {})} <main class="font-serif flex flex-col items-center px-6 md:px-0"> ${renderSlot($$result, $$slots["default"])} </main>   </body> </html>`;
...
const $$Prose = createComponent(async ($$result, $$props, $$slots) => {
  ...
  prose-a:text-blue-600 prose-img:rounded-xl prose-h1:my-12"> ${renderSlot($$result, $$slots["default"])} </div>`;
