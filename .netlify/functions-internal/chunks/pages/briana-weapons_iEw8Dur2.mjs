...
/* empty css                                   */
import 'html-escaper';
import { e as createAstro, f as createComponent, A as AstroError, g as ImageMissingAlt, r as renderTemplate, m as maybeRenderHead, h as addAttribute, s as spreadAttributes, i as renderComponent, j as renderHead, k as createTransitionScope, l as renderTransition, n as renderSlot, o as slide, _ as __astro_tag_component__, F as Fragment$1, p as createVNode } from '../astro_2vm9jCdL.mjs';
import { i as isESMImportedImage, g as getImage$1 } from '../astro/assets-service_w3Dqd6hz.mjs';
import 'clsx';
import 'kleur/colors';
...
const NextStation = () => {
  ...
  const navClasses = animating ? "p-[2vw] w-[9vw] h-full bg-white flex pointer-events-none opacity-50" : "p-[2vw] w-[9vw] h-full bg-white flex hover:bg-black";
  return /* @__PURE__ */ jsx("nav", { id: "menu", children: /* @__PURE__ */ jsx(
    "a",
    {
...
const $$BtnMenu = createComponent(async ($$result, $$props, $$slots) => {
  ...
  Astro2.self = $$BtnMenu;
  const baseClass = "cursor-pointer bg-white p-[2vw] flex flex-col justify-center gap-[0.5vw] w-[10vw] items-center hover:bg-black";
  return renderTemplate`${maybeRenderHead()}<a id="burger"${addAttribute(`${baseClass}`, "class")}> <i class="block bg-red-600 w-[3vw] h-[0.7vw]"></i> <i class="block bg-red-600 w-[3vw] h-[0.7vw]"></i> <i class="block bg-red-600 w-[3vw] h-[0.7vw]"></i> </a> `;
...
const $$Header = createComponent(async ($$result, $$props, $$slots) => {
  ...
  Astro2.self = $$Header;
  return renderTemplate`${maybeRenderHead()}<header${addAttribute(createTransitionScope($$result, "l7r54iwe"), "data-astro-transition-persist")}> <div id="banner" class="flex gap-[1vw] justify-between"> <div class="logo-container bg-white flex-grow"> ${renderComponent($$result, "Image", $$Image, { "class:list": "absolute left-[7vw] top-[2vw] w-[16vw]", "src": lqon, "alt": "Lo quieras o no" })} <video class="w-[10vw]" id="videoLogotipo" muted playsinline> <source${addAttribute(logotipo, "src")} type="video/mp4">
Tu navegador no soporta videos.
</video> </div> <div class="flex gap-[1vw]"> ${renderComponent($$result, "BtnMenu", $$BtnMenu, {})} ${renderComponent($$result, "NextStation", NextStation, { "client:load": true, "client:component-hydration": "load", "client:component-path": "/Users/aitor/Documents/Sites/lqon/src/components/NextStation.jsx", "client:component-export": "default" })} </div> </div> ${renderComponent($$result, "Fiber", Fiber, { "client:load": true, "client:component-hydration": "load", "client:component-path": "/Users/aitor/Documents/Sites/lqon/src/components/Fiber.jsx", "client:component-export": "default" })} </header>`;
...
const $$Solapa = createComponent(async ($$result, $$props, $$slots) => {
  ...
  Astro2.self = $$Solapa;
  return renderTemplate`${maybeRenderHead()}<div id="solapa" class="hidden top-0 left-0 w-full min-h-full bg-black z-[99999999999999]"> ${renderComponent($$result, "StationLinks", StationLinks, {})} </div>;`;
...
const $$Layout = createComponent(async ($$result, $$props, $$slots) => {
  ...
  Astro2.self = $$Layout;
  const { titulo, nombre, tipo } = Astro2.props;
  return renderTemplate`<html lang="en"> ${renderComponent($$result, "CommonHead", $$CommonHead, { "tipo": tipo, "nombre": nombre })}${maybeRenderHead()}<body class="text-white"> ${renderComponent($$result, "Header", $$Header, {})} <main class="font-serif"${addAttribute(renderTransition($$result, "yxpohs6f", slide({ duration: "1s" }), ""), "data-astro-transition-scope")}> ${renderSlot($$result, $$slots["default"])} </main> ${renderComponent($$result, "Solapa", $$Solapa, {})}   </body> </html>`;
