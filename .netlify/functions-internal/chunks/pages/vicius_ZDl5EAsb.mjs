...
const imagePortadaMobile = new Proxy({"src":"/_astro/vicius-1-vacaciones-mobile.7YR_SxN8.jpg","width":400,"height":400,"format":"jpg"}, {
...
const imagePortadaDesktop = new Proxy({"src":"/_astro/vicius-1-vacaciones-desktop.be68Q-10.jpg","width":800,"height":800,"format":"jpg"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
...
const imageContraportadaMobile = new Proxy({"src":"/_astro/vicius-2-vacaciones-mobile.qtF57Qgv.jpg","width":400,"height":400,"format":"jpg"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
...
const imageContraportadaDesktop = new Proxy({"src":"/_astro/vicius-2-vacaciones-desktop.QwBGrUkw.jpg","width":800,"height":800,"format":"jpg"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
