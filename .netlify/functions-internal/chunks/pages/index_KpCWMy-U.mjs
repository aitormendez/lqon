/* empty css                          */
import { e as createAstro, f as createComponent, r as renderTemplate, h as addAttribute, i as renderHead, j as renderComponent, k as renderSlot, m as maybeRenderHead } from '../astro_4mjw5gTI.mjs';
import 'kleur/colors';
import 'html-escaper';
import 'clsx';
...
function Header({ setIsAnimating }) {
}
/* @__PURE__ */ jsxs("header", { id: "banner", children: [
  " ",
  /* @__PURE__ */ jsx(
    "button",
    {
