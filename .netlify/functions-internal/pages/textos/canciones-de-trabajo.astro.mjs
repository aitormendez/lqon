...
const imageArbeitMobile = new Proxy({"src":"/_astro/Arbeit_macht_frei-mobile.kNZedu-5.jpg","width":400,"height":300,"format":"jpg"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
							if (name === 'fsPath') {
								return "/Users/aitor/Documents/Sites/lqon/src/assets/img/canciones-trabajo/Arbeit_macht_frei-mobile.jpg";
							}
...
const imageArbeitDesktop = new Proxy({"src":"/_astro/Arbeit_macht_frei-desktop.2S7crSzy.jpg","width":800,"height":600,"format":"jpg"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
							if (name === 'fsPath') {
								return "/Users/aitor/Documents/Sites/lqon/src/assets/img/canciones-trabajo/Arbeit_macht_frei-desktop.jpg";
							}
...
const imageCartelMobile = new Proxy({"src":"/_astro/cartel-mobile.60-76Lj7.jpg","width":289,"height":400,"format":"jpg"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
							if (name === 'fsPath') {
								return "/Users/aitor/Documents/Sites/lqon/src/assets/img/canciones-trabajo/cartel-mobile.jpg";
							}
...
const imageCartelDesktop = new Proxy({"src":"/_astro/cartel-desktop.yxkA8TL8.jpg","width":579,"height":800,"format":"jpg"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
							if (name === 'fsPath') {
								return "/Users/aitor/Documents/Sites/lqon/src/assets/img/canciones-trabajo/cartel-desktop.jpg";
							}
...
const imageAfricansMobile = new Proxy({"src":"/_astro/africans-americans-mobile.CqyYwNHs.jpg","width":400,"height":254,"format":"jpg","orientation":1}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
							if (name === 'fsPath') {
								return "/Users/aitor/Documents/Sites/lqon/src/assets/img/canciones-trabajo/africans-americans-mobile.jpg";
							}
...
const imageAfricansDesktop = new Proxy({"src":"/_astro/africans-americans-desktop.vNbFoEyI.jpg","width":800,"height":509,"format":"jpg","orientation":1}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
							if (name === 'fsPath') {
								return "/Users/aitor/Documents/Sites/lqon/src/assets/img/canciones-trabajo/africans-americans-desktop.jpg";
							}
...
const imageIntervencion1Mobile = new Proxy({"src":"/_astro/intervincion-anonima-1-mobile.Djwp8EaV.jpg","width":400,"height":300,"format":"jpg"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
							if (name === 'fsPath') {
								return "/Users/aitor/Documents/Sites/lqon/src/assets/img/canciones-trabajo/intervincion-anonima-1-mobile.jpg";
							}
...
const imageIntervencion1Desktop = new Proxy({"src":"/_astro/intervincion-anonima-1-desktop.7IIr4RVa.jpg","width":800,"height":600,"format":"jpg"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
							if (name === 'fsPath') {
								return "/Users/aitor/Documents/Sites/lqon/src/assets/img/canciones-trabajo/intervincion-anonima-1-desktop.jpg";
							}
...
const imageIntervencion2Mobile = new Proxy({"src":"/_astro/intervincion-anonima-2-mobile.Cxnf0aWX.jpg","width":400,"height":300,"format":"jpg"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
							if (name === 'fsPath') {
								return "/Users/aitor/Documents/Sites/lqon/src/assets/img/canciones-trabajo/intervincion-anonima-2-mobile.jpg";
							}
    ...
    children: [createVNode($$Layout, {
      ...
      children: createVNode($$Prose, {
        children: [createVNode(_components.h1, {
          ...
          desktopImgUrl: imageIntervencionMetro,
          caption: "Intervenci\xF3n an\xF3nima. Fotograf\xEDa de Editorial La Torre Magn\xE9tica.",
          alt: "alt"
        }), createVNode($$ImageCaption, {
          ...
          caption: "<i>The Old Plantation</i>. Esclavos cantan y bailan en una plantaci\xF3n de Carolina del Sur, USA. John Rose, circa 1780.",
          alt: "alt",
          hasCaption: true
        }), createVNode(_components.p, {
          ...
          caption: "Pie de foto",
          alt: "Si el trabajo fuera cosa buena lo guardar\xEDan los ricos para ellos solos",
          hasCaption: false
        }), createVNode(_components.p, {
