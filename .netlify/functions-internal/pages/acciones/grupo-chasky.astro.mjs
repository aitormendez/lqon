...
const image1 = new Proxy({"src":"/_astro/grupo-chasky-1.CAExZHie.png","width":1409,"height":725,"format":"png"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
							if (name === 'fsPath') {
								return "/Users/aitor/Documents/Sites/lqon/src/assets/img/grupo-chasky-1.png";
							}
...
const image2 = new Proxy({"src":"/_astro/grupo-chasky-5.DSh11Bem.png","width":1315,"height":786,"format":"png"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
							if (name === 'fsPath') {
								return "/Users/aitor/Documents/Sites/lqon/src/assets/img/grupo-chasky-5.png";
							}
  ...
  return createVNode($$Layout, {
    ...
    children: [createVNode($$Prose, {
      ...
      children: [createVNode($$ImageCaption, {
        ...
        alt: "Visuales del concierto Charijayak, Quito 1015",
        caption: "Visuales del concierto Charijayak, Quito 1015.",
        clase: "mt-20",
        hasCaption: false
