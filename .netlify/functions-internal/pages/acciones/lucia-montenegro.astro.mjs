...
const imageCasasDeCarton = new Proxy({"src":"/_astro/los-guaraguao-casas-de-carton-upscaled.DfMrLbso.jpg","width":2396,"height":2156,"format":"jpg"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
							if (name === 'fsPath') {
								return "/Users/aitor/Documents/Sites/lqon/src/assets/img/los-guaraguao-casas-de-carton-upscaled.jpg";
							}
  ...
  return createVNode($$Layout, {
    ...
    children: [createVNode($$Prose, {
      ...
      children: [createVNode($$ImageCaption, {
        ...
        caption: "Techos de cart\xF3n. Los Guaraguao",
        alt: "alt",
        clase: "mt-20"
